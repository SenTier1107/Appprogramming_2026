...
| **기말과고사**<br>14~15주차<br>2026.06.05~06.12 | [`adventureworks_crm`](https://github.com/SenTier1107/adventureworks_crm) | - AdventureWorks 자전거 판매 데이터 기반 **CRM 분석 · 예측 대시보드** (FastAPI MVC 구조)<br>- 데이터 전처리 · EDA · RFM+K-means 고객 세분화 · 연관규칙(장바구니) 분석<br>- **RandomForest 분류** — 첫 구매 정보 기반 액세서리 업셀 예측 (AUC 0.91, 재현율 95.2%, 혼동행렬 시각화)<br>- **RandomForest 회귀** — 상품·지역·시기 기반 판매량 예측 (R² 0.83)<br>- **SARIMA 시계열** — 미래 6개월 매출 예측 (MAPE 9.3%)<br>- '2020년 6월 매출 급락'을 데이터 절단(수집 중단+자전거 누락)으로 비판적 규명<br>- 8개 페이지 인터랙티브 대시보드 (Jinja2 + ApexCharts), 숫자 카운트업·차트 호버 효과<br>- pytest 기반 API 테스트 10종 통과 (페이지 로드·EDA 정합성·예측 정상/예외 검증)<br>- 대용량 데이터 집계 경량화로 배포 최적화<br>- Docker + Hugging Face Spaces 배포<br>- 🔗 [배포 URL](https://sentier2006-adventureworks-crm.hf.space) |
...
[![statsmodels](https://img.shields.io/badge/statsmodels-3F51B5?style=flat-square&logo=python&logoColor=white)](https://www.statsmodels.org/) [![ApexCharts](https://img.shields.io/badge/ApexCharts-008FFB?style=flat-square&logo=apachecharts&logoColor=white)](https://apexcharts.com/) [![pytest](https://img.shields.io/badge/pytest-0A9EDC?style=flat-square&logo=pytest&logoColor=white)](https://docs.pytest.org/) [![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)](https://www.docker.com/) [![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?style=flat-square&logo=huggingface&logoColor=black)](https://huggingface.co/)
